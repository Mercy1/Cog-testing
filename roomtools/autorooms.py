...
class AutoRooms(MixedMeta):
    ...
    @aa_active()
    @checks.admin_or_permissions(manage_channels=True)
    @autoroomset.command(name="voicesetup")
    ...
    @aa_active()
    @checks.admin_or_permissions(manage_channels=True)
    @autoroomset.command(name="unlock") 
    ...
    @aa_active()
    @checks.admin_or_permissions(manage_channels=True)
    @autoroomset.command(name="roompermit")
    ...
    @aa_active()
    @checks.admin_or_permissions(manage_channels=True)
    @autoroomset.command(name="roomreject")
    ...
    @aa_active()
    @checks.admin_or_permissions(manage_channels=True)
    @autoroomset.command(name="roomname")
    ...
    @aa_active()
    @checks.admin_or_permissions(manage_channels=True)
    @autoroomset.command(name="roomclaim")
